...
] = "mysql+mysqlconnector://soctix_user:soctix_pw@localhost/soctix"  # need this for database
...
app.config["MAIL_USERNAME"] = "testemail@gmail.com"
app.config["MAIL_PASSWORD"] = "itsfortesting12345"
mail = Mail(app)

from ticketer import routes
